...
function html5blank_styles()
{
    ...
    wp_register_style('nav', get_template_directory_uri() . '/css/nav.css', array(), '1.0', 'all');
...
add_action('init', 'create_post_type_featured_image'); // Add our HTML5 Blank Custom Post Type
...
function create_post_type_featured_image() {
    register_post_type('featured_images', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Featured Images', 'featured_images'), // Rename these to suit
            'singular_name' => __('Featured Image', 'featured_image'),
            'add_new' => __('Add New', 'featured_image'),
            'add_new_item' => __('Add New Featured Image', 'featured_image'),
            'edit' => __('Edit', 'featured_image'),
            'edit_item' => __('Edit Featured Image', 'featured_image'),
            'new_item' => __('New Featured Image', 'featured_image'),
            'view' => __('View Featured Image', 'featured_image'),
            'view_item' => __('View Featured Image', 'featured_image'),
            'search_items' => __('Search Featured Images', 'featured_image'),
            'not_found' => __('No Featured Images found', 'featured_image'),
            'not_found_in_trash' => __('No Featured Images found in Trash', 'featured_image')
        ),
        'public' => true,
        'hierarchical' => false, // Allows your posts to behave like Hierarchy Pages
        'has_archive' => false,
...
function create_post_type_slide() {
    register_post_type('slides', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Slides', 'slides'), // Rename these to suit
